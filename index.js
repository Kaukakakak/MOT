...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Fadhli\n' 
            + 'ORG:@itspapoy;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=4498179556:+44 9981-9556\n' 
            + 'END:VCARD' 
prefix = '/'
blocked = []          
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["4498179556@s.whatsapp.net"]
			const pacarNumber = ["4498179556@s.whatsapp.net"]
			const birdhaNumber = ["4498179556@s.whatsapp.net"]
          ...
          case 'ping':
            ...
            break
                ...
                case 'report':
                    ...
                    client.sendMessage('4498179556@s.whatsapp.net', options, text, {quoted: mek})
